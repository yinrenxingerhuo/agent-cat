                            ...
                            if(m.isAnnotationPresent(MethodCode.class)) {
                                mv = new AdviceAdapter(Opcodes.ASM5, mv, access, name, desc) {
                                    ...
                                    public void onMethodEnter() {
                                        ...
                                        this.visitMethodInsn(Opcodes.INVOKESTATIC, "com/jqh/agent/ProcessUtil", "setStartTime", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V",
                                                false);
                                    }
                                    ...
                                    public void onMethodExit(int opcode) {
                                        ...
                                        this.visitMethodInsn(Opcodes.INVOKESTATIC, "com/jqh/agent/ProcessUtil", "setEndTime", "(Ljava/lang/String;)V", false);
                                    }
                                };
                            }
                            if(m.isAnnotationPresent(EventCode.class)) {
                                mv = new AdviceAdapter(Opcodes.ASM5, mv, access, name, desc) {
                                    ...
                                    public void onMethodEnter() {
                                        ...
                                        this.visitLdcInsn(name);
                                        this.visitLdcInsn(desc);
                                        this.visitMethodInsn(Opcodes.INVOKESTATIC, "com/jqh/agent/ProcessUtil", "eventBegin", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V",
                                                false);
                                    }
                                    ...
                                    public void onMethodExit(int opcode) {
                                        this.visitLdcInsn(key);
                                        this.visitMethodInsn(Opcodes.INVOKESTATIC, "com/jqh/agent/ProcessUtil", "eventEnd", "(Ljava/lang/String;)V", false);
                                    }
                                };
                            }
                        }
